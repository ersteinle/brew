...
<div style="float: left; margin: 10px; position: relative;">
    <div style=" border: gray solid 1px;">
        ...
        <p>This scotch ale is the best IPA on the market! <br />Wait until you try our beautiful, hand crafted <br />heffeweissen, its to die for</p>
    </div>
</div>
<div style="float: left; margin: 10px;">
    <div style=" border: gray solid 1px;">
        ...
        <p>This scotch ale is the best IPA on the<br /> market! Wait until you try our beautiful,<br /> hand crafted heffeweissen, its to die for</p>
    </div>
</div>
<div style="float: left; margin: 10px;">
    <div style=" border: gray solid 1px;">
        ...
        <p>This scotch ale is the best IPA on the market! Wait <br />until you try our beautiful, hand crafted <br />heffeweissen, its to die for</p>
    </div>
</div>
<div style="float: left; margin: 10px;">
    <div style=" border: gray solid 1px;">
